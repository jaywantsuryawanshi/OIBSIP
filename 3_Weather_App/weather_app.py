...
class WeatherApp:
    ...
    def get_weather(self):
        ...
        weather_data = {
            ...
            "Delhi": {"temp": 25.8, "feels": 24.5, "humidity": 55, "wind": 12, "pressure": 1015, "clouds": 30, "condition": "Hazy 🌫️"},
            "Pune": {"temp": 27.1, "feels": 26.0, "humidity": 48, "wind": 10, "pressure": 1010, "clouds": 10, "condition": "Clear Sky ☀️"},
            "Bangalore": {"temp": 24.3, "feels": 23.8, "humidity": 70, "wind": 6, "pressure": 1016, "clouds": 40, "condition": "Cloudy ☁️"},
            "Nashik": {"temp": 28.9, "feels": 27.8, "humidity": 38, "wind": 9, "pressure": 1011, "clouds": 2, "condition": "Sunny ☀️"}
        }
        ...
        if city in weather_data:
            ...
            self.status_label.config(text=f"❌ {city} not in database", fg="#E74C3C")
            messagebox.showinfo("Try These", "Dhule, Mumbai, Delhi, Pune, Bangalore, Nashik")
